...
angular.module('ngWYSIWYG').directive('wysiwygEdit', ['ngpUtils', 'NGP_EVENTS', '$rootScope', '$compile', '$timeout', '$q',
	function (ngpUtils, NGP_EVENTS, $rootScope, $compile, $timeout, $q) {
		var linker = function (scope, $element, attrs, ctrl) {
			...
			scope.fontsizes = [{key: 1, name: 'x-small'}, {key: 2, name: 'small'}, {key: 3, name: 'normal'}, {
				key: 4,
				name: 'large'
			}, {key: 5, name: 'x-large'}, {key: 6, name: 'xx-large'}, {key: 7, name: 'xxx-large'}];
			 ...
			 */
			scope.styles = [{name: 'Paragraph', key: '<p>'}, {name: 'Header 1', key: '<h1>'}, {
				name: 'Header 2',
				key: '<h2>'
			}, {name: 'Header 3', key: '<h3>'}, {name: 'Header 4', key: '<h4>'}, {
				name: 'Header 5',
				key: '<h5>'
			}, {name: 'Header 6', key: '<h6>'}];
			...
			scope.customAction = function (actionType) {
